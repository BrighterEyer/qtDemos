...
{
    connect(ui->lineEdit, SIGNAL(textChanged(QString)), this, SLOT(enableDownloadButton()));
...
void DownloadManager::startRequest(QNetworkRequest &req)
{
    ...
    connect(m_reply, SIGNAL(readyRead()), this, SLOT(WriteFile()));
    connect(m_reply,SIGNAL(finished()),this,SLOT(downloadFinished()));
    connect(m_reply, SIGNAL(downloadProgress(qint64,qint64)),this, SLOT(DataProgress(qint64,qint64)));
